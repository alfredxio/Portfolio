        ...
        <div className="contact__container container grid">
            <div className="contact__content">
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">Dhanbad, Jharkhand(IN)</p>
                </div>
                <div className="contact__card">
                    <span className="contact__card-icon">
                        <FaRegUser />
                ...
                <div className="contact__card">
                    ...
                    <p className="contact__card-data">x.alfredio01@gmail.com</p>
                </div>
                <div className="contact__card">
                    <span className="contact__card-icon">
                        <FaRegAddressBook />
                    ...
                    <p className="contact__card-data">+91 8789517485</p>
                </div>
            </div>
